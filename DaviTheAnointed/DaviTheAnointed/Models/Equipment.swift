    ...
    private init() {
        ...
        items.append(contentsOf: [
            ...
            Equipment(id: "head_05", nameKey: "item.head.philistine_bronze_helm", slot: .head, rarity: .uncommon,
                      stats: CharacterStats(maxHP: 12, critChance: 0.05, armor: 7), price: 800, minLevel: 5, textureName: "head_05"),
            ...
            Equipment(id: "head_08", nameKey: "item.head.bronze_crown", slot: .head, rarity: .rare,
                      stats: CharacterStats(critChance: 0.05, armor: 10, lifeSteal: 0.03), price: 2000, minLevel: 10, textureName: "head_08"),
