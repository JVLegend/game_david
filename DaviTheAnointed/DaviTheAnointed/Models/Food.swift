...
struct FoodDatabase {
    ...
    private init() {
        allFoods = [
            ...
            Food(type: .waterSkin, nameKey: "food.water_skin", healAmount: 12,
                 buffEffect: BuffEffect(stat: "dodgeMelee", value: 0.03, duration: 8, descriptionKey: "food.water_skin.buff"),
                 price: 15, minLevel: 1, textureName: "food_water_skin"),

            Food(type: .grapes, nameKey: "food.grapes", healAmount: 25,
                 buffEffect: nil, price: 40, minLevel: 1, textureName: "food_grapes"),

            Food(type: .grapeJuice, nameKey: "food.grape_juice", healAmount: 32,
                 buffEffect: BuffEffect(stat: "critChance", value: 0.05, duration: 10, descriptionKey: "food.grape_juice.buff"),
                 price: 70, minLevel: 2, textureName: "food_grape_juice"),

            Food(type: .freshFigs, nameKey: "food.fresh_figs", healAmount: 28,
                 buffEffect: nil, price: 45, minLevel: 1, textureName: "food_fresh_figs"),
            ...
            Food(type: .olives, nameKey: "food.olives", healAmount: 10,
                 ...
                 price: 60, minLevel: 4, textureName: "food_grapes"),

            Food(type: .honeyBread, nameKey: "food.honey_bread", healAmount: 35,
                 buffEffect: nil, price: 80, minLevel: 5, textureName: "food_barley_bread"),
            ...
            Food(type: .pomegranate, nameKey: "food.pomegranate", healAmount: 30,
                 ...
                 price: 100, minLevel: 7, textureName: "food_grapes"),
            ...
            Food(type: .goatCheese, nameKey: "food.goat_cheese", healAmount: 40,
                 ...
                 price: 130, minLevel: 9, textureName: "food_fresh_figs"),
            ...
            Food(type: .dates, nameKey: "food.dates", healAmount: 25,
                 ...
                 price: 110, minLevel: 8, textureName: "food_dried_figs"),

            Food(type: .cookedLentils, nameKey: "food.cooked_lentils", healAmount: 50,
                 buffEffect: nil, price: 160, minLevel: 11, textureName: "food_fresh_figs"),
            ...
            Food(type: .roastedFish, nameKey: "food.roasted_fish", healAmount: 45,
                 ...
                 price: 180, minLevel: 13, textureName: "food_grape_juice"),
            ...
            Food(type: .raisinCake, nameKey: "food.raisin_cake", healAmount: 60,
                 ...
                 price: 220, minLevel: 15, textureName: "food_barley_bread"),
            ...
            Food(type: .roastedLamb, nameKey: "food.roasted_lamb", healAmount: 80,
                 ...
                 price: 300, minLevel: 18, textureName: "food_barley_bread"),
            ...
            Food(type: .manna, nameKey: "food.manna", healAmount: 100,
                 ...
                 price: 500, minLevel: 22, textureName: "food_barley_bread"),
            ...
            Food(type: .kingsFeast, nameKey: "food.kings_feast", healAmount: 120,
                 ...
                 price: 750, minLevel: 26, textureName: "food_fresh_figs"),
            ...
            Food(type: .celestialBanquet, nameKey: "food.celestial_banquet", healAmount: 150,
                 ...
                 price: 1000, minLevel: 30, textureName: "food_grape_juice"),
        ]
    }
